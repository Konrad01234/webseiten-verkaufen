...
└── boostwerk-schwarz/ Boostwerk Köln – Kfz-Werkstatt, schwarze Variante (statisches HTML + CSS + JS)
```
...
2. **Root Directory** auf den jeweiligen Ordner setzen:
   ...
   - Projekt „boostwerk-schwarz" → Root Directory `sites/boostwerk-schwarz`
