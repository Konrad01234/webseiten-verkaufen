...
├── eiscafefranco/           Eiscafé Franco (exportierte Seiten)
└── typgerechte-ernaehrung/  Typgerechte Ernährung – Horisan Metabolic Typing®
...
2. **Root Directory** auf den jeweiligen Ordner setzen:
   ...
   - Projekt „typgerechte-ernaehrung" → Root Directory `sites/typgerechte-ernaehrung`
