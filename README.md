...
└── bankshop/      Bankshop Broderstorf – Baufinanzierung bei Rostock (statisches HTML + CSS + JS)
```
...
2. **Root Directory** auf den jeweiligen Ordner setzen:
   ...
   - Projekt „bankshop" → Root Directory `sites/bankshop`
...
```bash
cd sites/davids        # oder: cd sites/bankshop
