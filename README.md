...
└── baufinanzierung/   baufinanzierung.biz – Neuentwurf mit Anfrage-Assistent (statisches HTML + CSS + JS)
```
...
2. **Root Directory** auf den jeweiligen Ordner setzen:
   ...
   - Projekt „baufinanzierung" → Root Directory `sites/baufinanzierung`
