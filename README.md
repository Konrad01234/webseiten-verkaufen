...
└── abnehmen-leverkusen/   Abnehmen im Liegen Leverkusen – Bodyforming-Studio (statisches HTML + CSS + JS)
```
...
2. **Root Directory** auf den jeweiligen Ordner setzen:
   ...
   - Projekt „abnehmen-leverkusen" → Root Directory `sites/abnehmen-leverkusen`
