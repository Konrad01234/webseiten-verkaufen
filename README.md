...
└── gelateria-lorenzo-corno/   Gelateria Lorenzo Corno – Eisdiele München-Schwabing (statisches HTML + CSS + JS)
```
...
2. **Root Directory** auf den jeweiligen Ordner setzen:
   ...
   - Projekt „gelateria-lorenzo-corno" → Root Directory `sites/gelateria-lorenzo-corno`
