...
├── eiscafefranco/   Eiscafé Franco (statisches HTML + JS)
└── geissler/        Geißler Heizungstechnik – Bochum (statisches HTML + CSS + JS, SaaS-Style)
```
...
2. **Root Directory** auf den jeweiligen Ordner setzen:
   ...
   - Projekt „geissler" → Root Directory `sites/geissler`
