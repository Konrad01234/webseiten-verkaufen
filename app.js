...
function sendChatMessage() {
  ...
  if (chat) {
    ...
    if (chat.partnerId) {
      let partnerId = null;
      if (chat.partnerId.startsWith('employer-')) partnerId = parseInt(chat.partnerId.replace('employer-', ''));
      else if (chat.partnerId.startsWith('worker-')) {
        // Find the worker's userId from applications
        const allApps = getAllApplications();
        const app = allApps.find(a => a.name === chat.partnerName);
        if (app) partnerId = app.userId;
      }
      if (partnerId) {
          ...
          <div class="profile-sections">
            <div class="profile-section">
              ...
              <div class="form-group">
                ...
                <input type="text" name="company" class="form-input" placeholder="Name des Unternehmens" value="${state.user.company || ''}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea name="description" class="form-textarea" placeholder="Beschreibe dein Unternehmen...">${state.user.description || ''}</textarea>
              </div>
            </div>
            ...
            <div class="profile-section">
              ...
              <div class="form-group">
                <label class="form-label">Adresse</label>
                <input type="text" name="address" class="form-input" placeholder="Straße, PLZ, Stadt" value="${state.user.address || ''}">
              </div>
              <div class="form-group">
                <label class="form-label">Telefon</label>
                <input type="tel" name="phone" class="form-input" placeholder="+49 ..." value="${state.user.phone || ''}">
              </div>
              <div class="form-group">
                <label class="form-label">Website</label>
                <input type="url" name="website" class="form-input" placeholder="https://..." value="${state.user.website || ''}">
              </div>
            </div>
            ...
            <div class="profile-section">
              ...
              <div class="form-row">
                <div class="form-group">
                  ...
                  <input type="number" name="founded" class="form-input" placeholder="z.B. 2020" value="${state.user.founded || ''}">
                </div>
                <div class="form-group">
                  <label class="form-label">Mitarbeiterzahl</label>
                  <input type="text" name="employees" class="form-input" placeholder="z.B. 10-50" value="${state.user.employees || ''}">
                </div>
              </div>
            </div>
          </div>
